...
pub async fn get_substations(state: State<'_, PowsyblState>) -> PowsyblResult<Vec<Substation>> {
...
#[tauri::command(rename_all = "snake_case")]
pub async fn load_substations(state: State<'_, PowsyblState>) -> PowsyblResult<FetchStatus> {
