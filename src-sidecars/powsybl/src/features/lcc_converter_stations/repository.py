...
class LccConverterStationsRepository(BaseRepository):
    ...
    def get_table_schema(self) -> str:
        return """
               CREATE TABLE lcc_converter_stations (
    ...
    def load_data(self) -> None:
        try:
            ...
            self._conn.execute(f"""
                ...
                (id, power_factor, loss_factor, p, q, i, voltage_level_id, 
                 bus_id, bus_breaker_bus_id, node, connected, fictitious)
                SELECT id, power_factor, loss_factor, p, q, i, voltage_level_id, 
                       bus_id, bus_breaker_bus_id, node, connected, fictitious
    ...
    def get_network_data(self) -> pd.DataFrame:
        return self._network.get_lcc_converter_stations(all_attributes=True)