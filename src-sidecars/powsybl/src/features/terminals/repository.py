...
class TerminalsRepository(BaseRepository):
    ...
    def load_data(self) -> None:
        try:
            ...
            self._conn.execute(f"""
                ...
                (element_id, voltage_level_id, bus_id, element_side)
                SELECT element_id, voltage_level_id, bus_id, element_side
    ...
    def get_network_data(self) -> pd.DataFrame:
        return self._network.get_terminals(all_attributes=True)