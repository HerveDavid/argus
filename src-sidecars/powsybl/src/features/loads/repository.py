...
class LoadsRepository(BaseRepository):
    ...
    def load_data(self) -> None:
        try:
            ...
            self._conn.execute(f"""
                ...
                (id, type, p0, q0, p, q, i, voltage_level_id,
                 bus_id, bus_breaker_bus_id, node, connected, fictitious)
                SELECT id, type, p0, q0, p, q, i, voltage_level_id,
                       bus_id, bus_breaker_bus_id, node, connected, fictitious
    ...
    def get_network_data(self) -> pd.DataFrame:
        return self._network.get_loads(all_attributes=True)