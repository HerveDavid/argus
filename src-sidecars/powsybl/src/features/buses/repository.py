...
class BusesRepository(BaseRepository):
    ...
    def load_data(self) -> None:
        try:
            ...
            self._conn.execute(f"""
                ...
                (id, v_mag, v_angle, connected_component, synchronous_component, voltage_level_id)
                SELECT id, v_mag, v_angle, connected_component, synchronous_component, voltage_level_id
    ...
    def get_network_data(self) -> pd.DataFrame:
        return self._network.get_buses(all_attributes=True)