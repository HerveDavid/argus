...
@router.post("/phase_tap_changer/{changer_id}")
async def update_phase_tap_changer(
        changer_id: str,
        tap: Optional[int] = Form(None),
        regulating: Optional[bool] = Form(None),
        regulation_mode: Optional[str] = Form(None),
        regulation_value: Optional[float] = Form(None),
    ...
    return await update_element_generic(
        changer_id, "phase_tap_changers", network.update_phase_tap_changers,
